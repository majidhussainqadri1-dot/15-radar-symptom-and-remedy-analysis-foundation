            ...
            <section class="rsr-panel">
                ...
                <div class="rsr-card-grid">
                    <?php foreach ((array)$report['sources'] as $source) : ?>
                        <article class="rsr-card"><h3><?php echo esc_html((string)$source['name']); ?></h3><dl><div><dt><?php esc_html_e('Dataset', RSR_TEXT_DOMAIN); ?></dt><dd><?php echo esc_html((string)$source['dataset']); ?></dd></div><div><dt><?php esc_html_e('License', RSR_TEXT_DOMAIN); ?></dt><dd><?php echo esc_html((string)$source['license_code']); ?></dd></div><div><dt><?php esc_html_e('Quality', RSR_TEXT_DOMAIN); ?></dt><dd><?php echo esc_html(number_format_i18n((float)$source['quality_score'] * 100, 1)); ?>%</dd></div></dl></article>
                    <?php endforeach; ?>
                </div>
            </section>
